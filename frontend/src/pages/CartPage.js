              ...
              <div style={styles.qtyCol}>
                <div style={styles.qtyControl}>
                  ...
                  <button
                    ...
                    style={{
                      ...styles.qtyBtn,
                      opacity: item.qty >= Math.min(item.countInStock, 5) ? 0.4 : 1,
                    }}
        ...
        <div style={styles.summaryCard}>
          ...
          <div style={styles.summaryRows}>
            ...
            <div style={styles.summaryRow}>
              ...
              <span style={{ ...styles.summaryValue, color: '#16a34a', fontWeight: '700' }}>
                FREE
              </span>
            </div>
          </div>
          ...
          <div style={styles.trustRow}>
            <div style={styles.trustItem}>
              ...
              <span style={styles.trustText}>Secure checkout</span>
            </div>
            <div style={styles.trustItem}>
...
const styles = {
  ...
  qtyDisplay: {
    ...
    color: '#1a1a2e', borderLeft: '1px solid #e5e7eb',
  ...
  summaryDivider: {
    height: '1px', backgroundColor: '#f0f0f0',
    margin: '16px 0',
  },
  totalRow: {
  ...
  checkoutBtn: {
    width: '100%', backgroundColor: '#0f1923',
    color: '#FFD814', border: 'none',
